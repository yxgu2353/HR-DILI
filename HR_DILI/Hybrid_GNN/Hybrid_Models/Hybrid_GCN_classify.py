...
def run_a_train_epoch(args, epoch, model, data_loader, loss_criterion, optimizer):
    ...
    Train_performance.to_csv(r'result/GCN/GCN_' + str(i) + '/Train_result.csv', mode='a', index=False)
...
def run_an_valid_epoch(model, data_loader, loss_criterion):
    ...
    Valid_performance.to_csv(r'result/GCN/GCN_' + str(i) + '/Valid_result.csv', mode='a', index=False)
...
def run_an_test_epoch(model, data_loader, loss_criterion):
    ...
    with torch.no_grad():
        ...
        Test_performance.to_csv(r'result/GCN/GCN_' + str(i) + '/Test_result.csv', mode='a', index=False)
...
def main(args, train_set, valid_set, test_set):
    ...
    # model setting
    model = GCNFeature(in_feats=n_feats,
    ...
    optimizer = Adam(model.parameters(), lr=0.006, weight_decay=3.46e-05)
    stopper = EarlyStopping(patience=20, filename=r'result/GCN/GCN_' + str(i) + '/model_best.pth', metric='roc_auc_score')
    ...
    e.to_csv(r'result/GCN/GCN_' + str(i) + '/Training_loss_auc.csv')

    # Save model
    fn = r'result/GCN/GCN_' + str(i) + '/Early_stop_model.pt'
    ...
    i = 10
    with open(r'result/GCN/GCN_' + str(i) + '/test_result.txt', 'w') as f:
...
if __name__ == '__main__':
    ...
    train_datasets = load_data(train_dc, r'result/GCN/GCN_' + str(i) + '/train', feat_size)
    valid_datasets = load_data(valid_dc, r'result/GCN/GCN_' + str(i) + '/valid', feat_size)
    test_datasets = load_data(test_dc, r'result/GCN/GCN_' + str(i) + '/test', feat_size)
