...
def bayesian_optimization(args, train_set, val_set, test_set):
    ...
    trials = Trials()
    best=fmin(objective, candidate_hypers, algo=tpe.suggest, max_evals=args['num_evals'],trials=trials)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-mo', '--model', choices=['GCN', 'GAT', 'Weave', 'MPNN', 'AttentiveFP','Graphsage',
